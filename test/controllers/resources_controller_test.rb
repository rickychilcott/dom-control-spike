...
class ResourcesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resource" do
    assert_difference("Resource.count") do
      post resources_url, params: { resource: { ancestry: @resource.ancestry, name: @resource.name } }
    end
  ...
  test "should update resource" do
    patch resource_url(@resource), params: { resource: { ancestry: @resource.ancestry, name: @resource.name } }
